...
export function ArtistCard({ artist, themeColor }: { artist: Artist; themeColor?: string }) {
  ...
  return (
    <Link
      ...
      className="group block rounded-xl border border-border shadow-lg overflow-hidden w-[300px] h-[450px] flex flex-col bg-card transition-all duration-300 hover:shadow-2xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:ring-offset-2 focus:ring-offset-background"
      style={{ 
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center" style={{height: '260px'}}>
        <div className="flex-1" />
        <div
          className="relative w-48 h-48 rounded-full border-4 bg-background overflow-hidden flex items-center justify-center shadow-xl"
      ...
      <div className="flex-1 flex flex-col items-center justify-start px-4 pb-4">
        <h3 
          className="text-3xl font-extrabold text-center leading-tight mb-2 tracking-tight" 
          style={{ 
            color: textColor, 
        ...
        {artist.fields.Speciality && (
          <p 
            className="text-base text-center mb-2 leading-tight opacity-80 font-medium" 
            style={{ 
              color: textColor, 
        ...
        <div className="mt-auto text-center w-full">
          <span 
            className="text-base font-semibold hover:underline transition-colors inline-flex items-center gap-1 opacity-90" 
            style={{ 
